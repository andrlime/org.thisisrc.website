...
class App extends React.Component {
  ...
  setLogoSize (e) {
    ...
    const op = (window.scrollY - 500) / 100 + 0.2 // opacity
    if (op > 0.2) this.setState({ opacity: op })
    else this.setState({ opacity: 0.2 })
  }

  modalHandler (e) {
    const s = !this.state.videoModal
  ...
  render () {
    ...
    const dates = [
      { date: new Date('2022-05-15T23:59:59'), desc: 'Registration Deadline' },
      { date: new Date('2022-05-15T00:00:00'), desc: 'Submission Deadline' },
    ...
    return (
      <div className={styles.earth}>
        <div
          ...
          style={{ display: this.state.videoModal ? 'none' : 'block' }}
        >
          <div className={styles.wrapper}>
            <div>
              <svg version='1.1' x='0px' y='0px' viewBox='0 0 64 64'>
                <path
                  d='M15.2,15c3,0,5.5,2.5,5.5,5.5s-2.5,5.5-5.5,5.5s-5.5-2.5-5.5-5.5S12.2,15,15.2,15 M15.2,9C8.9,9,3.8,14.1,3.8,20.5
                  s5.1,11.5,11.5,11.5s11.5-5.1,11.5-11.5S21.6,9,15.2,9L15.2,9z'
                />
                <path
                  d='M36.5,15c3,0,5.5,2.5,5.5,5.5s-2.5,5.5-5.5,5.5s-5.5-2.5-5.5-5.5S33.5,15,36.5,15 M36.5,9c-6.3,0-11.5,5.1-11.5,11.5
                ...
                <rect
                  ...
                  width='38.3'
                  height='17.8'
                  style={{ strokeWidth: '6', strokeMiterlimit: '10' }}
                />
                <polygon
                  style={{ strokeWidth: '6', strokeMiterlimit: '10' }}
                  points='41.3,42.6 59.2,53 59.2,32.3 '
                />
              </svg>
            </div>
        ...
        <div
          ...
          onClick={this.modalHandler}
          style={{ display: this.state.videoModal ? 'block' : 'none' }}
        />
        ...
        <div className={styles.main}>
          ...
          <div
            style={{
              backgroundImage: 'url(https://cdn.thisisrc.org/cover-image.png)',
          ...
          <div className={styles.mainContent}>
            <div className={styles.photos}>
              {[
                ...
                ['https://cdn.thisisrc.org/dhodh-models.jpeg', '55', '22']
              ].map((i, index) => (
                <div
                  key={i}
                  className={styles.img__colorpreload}
                  style={{
                    backgroundImage: `url(${i[0]})`,
                    width: `${i[1]}rem`,
                    height: `${i[2]}rem`,
                    marginBottom: '2rem',
            ...
            <div className={styles.timeline}>
              <div id={styles.box}>
                ...
                <ol>
                  <li>
                    Register at <a href='/register/student'>here</a>.
                  </li>
                  <li>Remember to pay! Cost per entry is ¥100.</li>
                  <li>
                    Wait for our confirmation email. We will email you once we
                    confirm your payment. If you do not receive an email, feel
                    free to reach out!
                  </li>
                </ol>
                <br />
